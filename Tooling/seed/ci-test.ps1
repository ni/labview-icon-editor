...
$project = Join-Path $PSScriptRoot '..\dotnet\VipbJsonTool\VipbJsonTool.csproj'
dotnet restore $project -ErrorAction Stop
dotnet build $project -c Release --no-restore -ErrorAction Stop
