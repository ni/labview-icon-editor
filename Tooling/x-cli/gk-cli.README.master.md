...
You can also download your corresponding package (`.deb`, `.rpm`) from the [releases page](https://github.com/gitkraken/gk-cli/releases) and install it with:
...
`gk` is available from [Winget](https://learn.microsoft.com/windows/package-manager/winget/) with the following command:
...
- Help Center: https://help.gitkraken.com/cli/
- Contact Support: https://help.gitkraken.com/contact-support/
