...
{
    private static readonly string[] AllowedProcessStartTypes =
    {
        "XCli.Util.ProcessUtil"
    };
    ...
    {
        var bypass = Env.GetStringOrDefault("XCLI_ALLOW_PROCESS_START");
        ...
        {
            if (AllowedProcessStartTypes.Contains(type.FullName))
                continue;
