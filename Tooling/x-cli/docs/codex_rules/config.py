...
def load_config(path: str | None = None) -> Dict:
    ...
    Configuration files may be in YAML or JSON format. YAML support prefers
    ruamel.yaml (falls back to PyYAML if available); otherwise the loader
    will attempt to parse JSON.
