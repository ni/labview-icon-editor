...
- LabVIEW 2020 (20.0) 32-bit and 64-bit installed (minimum supported baseline).
...
- The script always runs both 64-bit and 32-bit steps for the `.lvversion` target (canonical baseline: `20.0`).
