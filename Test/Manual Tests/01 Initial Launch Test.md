...
4. Verify the Icon Editor is in the middle of the main monitor.
5. Verify the Icon Text->Font combobox is properly populated based on fonts installed on the system.
6. If Small Fonts is installed, verify Small Fonts is selected in the Font combobox. If not installed, verify "LabVIEW Application" is selected.
7. Verify the font alignment is "center" and the font size is 9.
8. Launch the Icon Editor Properties via the tools menu.
9. Verify the Templates category is selected.
10. Verify the following settings in the Templates category:
...
11. Verify the following settings in the Layers category:
- "Merge all layers on commit" is unchecked.
12. Verify the following settings in the Text Tool category:
...
- Alignment is "center"
- Size is 9
13. Close the Icon Editor Properties dialog.
14. Close the Icon Editor.
15. From the VI Front Panel, double-click on the VI Icon.
