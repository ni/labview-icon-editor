...
| V1-C4 | none (new contract) | VR-PUB-001, VR-PUB-002, VR-PUB-003, VR-PUB-004, VR-PUB-005, VR-PUB-006, VR-PUB-007, VR-AST-003, VR-FAIL-002 | Core | Clarifying | Define immutable prerelease create-or-verify semantics, `.lvversion` minimum-version release-body behavior, publish outputs, and status artifact contract. | A-008, A-009, A-013, A-014 |
...
| V1-C8 | V1-C6 | VR-OPS-007, VR-OPS-008, VR-OPS-009 | Extended | Clarifying | Standardize branch protection on canonical context `CI Required / Lint+Contract` (backed by lint + pipeline-contract) and add operational runtime SLO telemetry artifacts for ci_profile performance tracking. | A-017 |
