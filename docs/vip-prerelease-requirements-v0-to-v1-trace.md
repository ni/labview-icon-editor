...
| V1-C8 | V1-C6 | VR-OPS-007, VR-OPS-008, VR-OPS-009 | Extended | Clarifying | Standardize branch protection on `PowerShell Lint` plus pipeline-contract and add operational runtime SLO telemetry artifacts for ci_profile performance tracking. | A-017 |
