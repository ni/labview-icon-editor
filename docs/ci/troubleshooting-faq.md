...
**Solution**:
1. Ensure you’ve actually installed LabVIEW on the machine (e.g., LabVIEW 2020 (20.0)).
...
**Possible Causes**:
- One or more LabVIEW Icon API files are missing in the LabVIEW 2020 (20.0) install.
...
**Answer**:  
CI usage is standardized on **LabVIEW 2020 (20.0), 32-bit and 64-bit** as the minimum supported baseline. If you want to use a different version locally, keep `.lvversion` and workflow/script overrides aligned.
