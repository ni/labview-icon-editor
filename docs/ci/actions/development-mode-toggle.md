...
### Integration Tests
You can run the integration tests locally on a runner that has LabVIEW 2020 (20.0) 32-bit or 64-bit installed. The scripts default to `.lvversion`; if you pass `-LabVIEWVersion`, it must match.
