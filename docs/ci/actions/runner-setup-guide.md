...
1. **Install Required Software**
   - Ensure **LabVIEW 2020 (20.0) 32-bit and 64-bit** are installed.
   - [PowerShell 7+](https://github.com/PowerShell/PowerShell/releases/latest)
   - [Git for Windows](https://github.com/git-for-windows/git/releases/latest)

2. **Apply the VIPC**
  - Apply `.github/actions/apply-vipc/runner_dependencies.vipc` with VIPM in **LabVIEW 2020 (20.0) 32-bit**; repeat for **LabVIEW 2020 (20.0) 64-bit**.
...
1. **Install LabVIEW 2020 (20.0), 32-bit and 64-bit**  
...
- `LABVIEW_VERSION_YEAR` / `LABVIEW_MINOR_REVISION` → derived from `.lvversion` (e.g., `20.0` → `2020` and minor `0`)
