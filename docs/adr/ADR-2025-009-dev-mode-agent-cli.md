...
- **Interfaces/CLI example**:  
  `dotnet run --project Tooling/dotnet/DevModeAgentCli/DevModeAgentCli.csproj -- --phrase "/devmode bind 2021 64-bit force and unbind 2023 both-bit" --repo . --summary reports/dev-mode-bind.json --execute --expected-version 2021 --ack-version-mismatch --allow-stale-summary --max-intents 3 --pwsh pwsh`  
