...
- Recommend rerunning with Force to bind this repo (VS Code task “Dev Mode (interactive bind/unbind)” with Force, or CLI: pwsh scripts/bind-development-mode/BindDevelopmentMode.ps1 -RepositoryPath . -Mode bind -Bitness both -Force).
