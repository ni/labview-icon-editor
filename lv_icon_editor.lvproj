...
<Project Type="Project" LVVersion="21008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Custom Icon Editor path token name--Constant.vi" Type="VI" URL="../resource/plugins/NIIconEditor/Miscellaneous/Custom Icon Editor path token name--Constant.vi"/>
			<Item Name="Read or create tokens on LabVIEW INI.vi" Type="VI" URL="../resource/plugins/NIIconEditor/Miscellaneous/Read or create tokens on LabVIEW INI.vi"/>
		</Item>
