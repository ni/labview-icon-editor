...
.SYNOPSIS
  Example usage:
    .\Build.ps1 -RelativePath "C:\labview-icon-editor-fork" -AbsolutePathScripts "C:\labview-icon-editor\pipeline\scripts" -Major 1 -Minor 0 -Patch 0 -Build 0 -Commit "Placeholder"
#>
