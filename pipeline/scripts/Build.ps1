...
try {
    ...
    Execute-Script ".\Applyvipc.ps1 -MinimumSupportedLVVersion 2021 -SupportedBitness 32 -RelativePath `"$RelativePath`" -VIPCPath `"$RelativePath\Tooling\deployment\Dependencies.vipc`" -VIP_LVVersion '2021'" 
    ...
    Execute-Script ".\Applyvipc.ps1 -MinimumSupportedLVVersion 2021 -SupportedBitness 64 -RelativePath `"$RelativePath`" -VIPCPath `"$RelativePath\Tooling\deployment\Dependencies.vipc`" -VIP_LVVersion '2021'" 
    ...
    Execute-Script ".\build_vip.ps1 -SupportedBitness 64 -RelativePath `"$RelativePath`" -VIPBPath `"$RelativePath\Tooling\deployment\NI Icon editor.vipb`" -VIP_LVVersion 2021 -MinimumSupportedLVVersion 2021" 
